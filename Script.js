function initengahan(){
  ...
  async function pertanyaan(){var { isConfirmed: prtanya } = await swals.fire({title: + tanya, text:'Mau kado Gak Nih' + opstanya, imageUrl: '' + fotostiker6.src, showCancelButton: true, confirmButtonText: '' + tompositif, cancelButtonText: '' + tomnegatif,});
    if(prtanya){
